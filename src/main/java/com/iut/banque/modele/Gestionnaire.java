...
public class Gestionnaire extends Utilisateur {
	 ...
	 */
	public Gestionnaire(String nom, String prenom, String adresse, boolean homme, String usrId, String usrPwd,String mail) throws IllegalFormatException {
		super(nom, prenom, adresse, homme, usrId, usrPwd, mail);
		if ("".equals(usrId)) {
